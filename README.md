...
Работа проекта протестирована на Kali Linux и Debian. Разрабатывалась именно под эти дистрибутивы. Временно работа скрипта возможно только из под root.
...
PATH_TO=/home/user/Documents ./this_script.sh -g
```
