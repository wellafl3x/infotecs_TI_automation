...
При конфигурировании доступа по протоколу SMB достаточно использовать флаг -smb единожды. При повторном использовании конфигурация SMB будет перезаписана.
